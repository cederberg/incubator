...
from . import python, go, java, rust, swift, c, ruby, php, shell, javascript, csharp, perl, zig, rst, markdown
from outliner.types import OutlineItem

_MODULES = [python, go, java, rust, swift, c, ruby, php, shell, javascript, csharp, perl, zig, rst, markdown]
