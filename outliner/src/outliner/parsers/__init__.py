...
from . import python, scala, go, java, rust, swift, c, ruby, php, shell, javascript, csharp, perl, zig, rst, markdown
from outliner.types import OutlineItem

_MODULES = [python, scala, go, java, rust, swift, c, ruby, php, shell, javascript, csharp, perl, zig, rst, markdown]
