...
name: interview-me
description: >
  Conduct a deep, structured interview to reach shared understanding of a plan
  or topic, then document the outcome.
...
**One question at a time.** Don't batch questions — it's overwhelming and people
give shallower answers.

**Suggest answers when you can.** If context gives you a reasonable guess, offer
it. If you can find an answer from the codebase, use a sub-agent in the
...
- You understand the _why_ behind the plan, not just the _what_
...
plan's major dimensions. Ask user to confirm correctness and completeness, or to
